...
public class BoardDao {
	...
	public List<Board> selectList() throws Exception {
		...
		try {
			...
			while (rs.next()) {
				boards.add(new Board().setBoardNo(rs.getInt("rboard_no")).setWriter(rs.getString("writer"))
						.setBoardTitle(rs.getString("rboard_title")).setBoardContent(rs.getString("rboard_content"))
	...
	public int insert(Board board) throws Exception {
		...
		final String sqlInsert = "INSERT INTO reviewboard(rboard_no,writer,rboard_title,rboard_content,reg_date) "
									+ "VALUES(?, ?, ?, ?, NOW())";
